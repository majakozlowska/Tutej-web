        ...
        <div className={style.mainContainer}>
            ...
            <div className={style.container}>
                ...
                <div className={style.form}>
                    ...
                    <InputField placeholder="Adres e-mail" type="email" icon="at" onChange={(val) => setEmail(val)} />
                    <InputField placeholder="Hasło" type="password" icon="lock" onChange={(val) => setPassword(val)} />
