...
import Select, { components, type DropdownIndicatorProps, type ValueContainerProps } from 'react-select';
...
const CustomValueContainer = ({ children, ...props }: ValueContainerProps<NeighborhoodOption, false>) => (
